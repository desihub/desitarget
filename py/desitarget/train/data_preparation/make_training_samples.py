...
parser.add_argument( '-i1', '--infits_qso', type = str, required = True, help = 'input qso fits')
parser.add_argument( '-i2', '--infits_stars', type = str, required = True, help = 'input stars fits')
parser.add_argument( '-o1', '--outfits_qso', type = str, required = True, help = 'output qso fits' )
parser.add_argument( '-o2', '--outfits_stars', type = str, required = True, help = 'output stars fits' )
args = parser.parse_args()

# Input files
fpn_STARS_input = args.infits_stars
fpn_QSO_input  = args.infits_qso

# Output files
fpn_STARS_output  = args.outfits_stars
fpn_QSO_output = args.outfits_qso
