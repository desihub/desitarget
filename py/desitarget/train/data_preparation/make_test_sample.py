...
parser.add_argument( '-i', '--infits', type = str, required = True,
                     default = './Data/TEST_DR8s.fits',
                     metavar = 'INFITS', help = 'input fits',)
parser.add_argument( '-o', '--outfits', type = str, required = True,
                     default = './Res/TestSample_DR8s.fits',
                     metavar = 'OUTFITS', help = 'output fits' )
parser.add_argument( '-n', '--north', action = 'store_true', required = False,
                     help = 'Enable "shift_photo_north"' )
args = parser.parse_args()

fpn_input = args.infits
fpn_output = args.outfits
is_north = args.north
