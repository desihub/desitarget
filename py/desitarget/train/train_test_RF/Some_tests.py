...
def plot_importance_feature(show=True, save=True, savename='Res_Compare/importance_feature.pdf'):
...
def plot_cut_selection(show=True, save=True, savename='Res_Compare/cut_selection.pdf'):
    ...
    ax3.set_ylabel(f'RF_{new_release} Probability', labelpad=14)
    ...
    ax4.set_ylabel(f'RF_{new_release}_HighZ Probability', rotation=270, labelpad=22)
...
def plot_completness(N_bins_r=10, N_bins_z=10, show=True, save=True, savename='Res_Compare/completeness.pdf'):
    ...
    ax1.errorbar(x=bin_centers, y=ratio, yerr=errors, linestyle='none', marker='.',color='green', label=f"RF {new_release}")
    ...
    ax2.errorbar(x=bin_centers, y=ratio, yerr=errors, linestyle='none', marker='.',color='green', label=f"RF {new_release}")
...
print("Raised Error is OK --> no poblemo :) ")
sel_qso = zred>0
...
plot_importance_feature(True, False)
plot_cut_selection(True, False)
plot_completness(N_bins_r=40, N_bins_z=40, show=True, save=False)
