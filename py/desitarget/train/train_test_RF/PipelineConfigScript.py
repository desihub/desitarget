...
# Training and test sample file path names
fpn_STARS_TrainingSample = "../data_preparation/Res/STARS_TrainingSample_DR9s.fits"
fpn_QSO_TrainingSample = "../data_preparation/Res/QSO_TrainingSample_DR9s.fits"
fpn_TestSample = "../data_preparation/Res/TestSample_DR9s.fits"

# QLF file path name
fpn_QLF = "../data_preparation/ROSS4_tabR"
...
parser.add_argument( '--config_fpn', type = str, required = False,
                     default = './WorkingDir/config.npz',
...
fpn_config = "./WorkingDir/config.npz"
