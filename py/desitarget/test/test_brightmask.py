...
class TestBRIGHTMASK(unittest.TestCase):
    ...
    def test_collect_bright_sources(self):
        ...
        bs1 = brightmask.collect_bright_sources('grz',[9,9,9],rootdirname=self.bsdatadir,outfilename=self.testbsfile)
    ...
    def test_make_bright_source_mask(self):
        ...
        mask = brightmask.make_bright_source_mask('grz',[9,9,9],infilename=self.testbsfile,outfilename=self.testmaskfile)
    ...
    def test_non_mask_targets(self):
        ...
        mask = brightmask.make_bright_source_mask('RZ',[8,10],rootdirname=self.bsdatadir,outfilename=self.testmaskfile)
