...
class TestBRIGHTSTAR(unittest.TestCase):
    ...
    def test_collect_bright_stars(self):
        ...
        bs1 = brightstar.collect_bright_stars('grz', [9, 9, 9],
    ...
    def test_make_bright_star_mask(self):
        ...
        bs1 = brightstar.collect_bright_stars('grz', [23, 23, 23],
                                              rootdirname=self.bsdatadir, outfilename=self.testbsfile)
        # ADM create a bright star mask from the collection of bright stars and write to file...
        mask = brightstar.make_bright_star_mask('grz', [23, 23, 23],
        ...
        mask2 = brightstar.make_bright_star_mask('grz', [23, 23, 23],
                                                 rootdirname=self.bsdatadir)
