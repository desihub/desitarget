...
############################################################
def combine_targets_truth(input_targets,
                          input_truth        = None,
                          output_dir         = './',
    ...
    master_target_table = astropy.table.vstack(target_data)
    ...
    for input_truth_path in input_truth_list:
        ...
        t = Table.read(input_truth_path)
        truth_data.append(t)
    
    # Combine TRUTH tables
    master_truth_table = astropy.table.vstack(truth_data)
