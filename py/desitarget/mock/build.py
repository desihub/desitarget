...
def join_targets_truth(output_dir, nside=64, verbose=True, clobber=False, qaplots=False):
    """Combine all the target and truth catalogs generated by targets_truth into a
    monolithic targets.fits and truth.fits file and optionally generate QA
    figures.

    select_mock_targets --output_dir debug --join
