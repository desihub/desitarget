...
for i in range(0, nrows):
   ...
   if  tbdata['brick_primary'][i] == 84:
      ...
      band=dict(u=0,g=1,r=2,i=3,z=4,y=5) #u's 8 aperatures, then g's 8 aperatures etc
      line_decap=[]
      for b in band.keys():
        line_decap+= [ tbdata['decam_apflux'][i][band[b]][0], tbdata['decam_apflux'][i][band[b]][1], tbdata['decam_apflux'][i][band[b]][2], tbdata['decam_apflux'][i][band[b]][3], tbdata['decam_apflux'][i][band[b]][4], tbdata['decam_apflux'][i][band[b]][5], tbdata['decam_apflux'][i][band[b]][6], tbdata['decam_apflux'][i][band[b]][7], tbdata['decam_apflux_resid'][i][band[b]][0], tbdata['decam_apflux_resid'][i][band[b]][1], tbdata['decam_apflux_resid'][i][band[b]][2], tbdata['decam_apflux_resid'][i][band[b]][3], tbdata['decam_apflux_resid'][i][band[b]][4], tbdata['decam_apflux_resid'][i][band[b]][5], tbdata['decam_apflux_resid'][i][band[b]][6], tbdata['decam_apflux_resid'][i][band[b]][7], tbdata['decam_apflux_ivar'][i][band[b]][0], tbdata['decam_apflux_ivar'][i][band[b]][1], tbdata['decam_apflux_ivar'][i][band[b]][2], tbdata['decam_apflux_ivar'][i][band[b]][3], tbdata['decam_apflux_ivar'][i][band[b]][4], tbdata['decam_apflux_ivar'][i][band[b]][5], tbdata['decam_apflux_ivar'][i][band[b]][6], tbdata['decam_apflux_ivar'][i][band[b]][7] ] 
